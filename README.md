...
- Replace the textarea with Monaco Editor integration.
- Parse markdown slides by splitting on `---` and render per-slide navigation.
- Add your first built-in theme pack and theme switcher.
- Add presenter mode with a secondary BrowserWindow.
